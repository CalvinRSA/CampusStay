// src/App.tsx - FIXED VERSION with URL cleanup
...
const App: React.FC = () => {
  ...
  // ✅ ADDED: Clean up index.html from URL automatically
  useEffect(() => {
    const cleanUrl = () => {
      ...
      if (currentPath.includes('index.html')) {
        ...
        console.log('🧹 Cleaning URL:', window.location.href, '→', newUrl);
